...
public class ConfigurationChangeListner implements Runnable {
  ...
  private void register(final String file) throws IOException, InterruptedException {
  ...
  public void configurationChanged(final String file) throws InterruptedException {
